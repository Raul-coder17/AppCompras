...
export default function StoreSummary({ items, selectedStoreFilter, onSelectStoreFilter }: StoreSummaryProps) {
  ...
  return (
    <div className="bg-white rounded-3xl border border-slate-100 p-6 md:p-8 shadow-sm flex flex-col h-full" id="store-summary-container">
      <div className="flex justify-between items-center mb-5">
        <div>
          ...
          <p className="text-xs text-slate-400 mt-0.5">Distribución de tu capital por establecimiento</p>
        </div>
        {selectedStoreFilter && (
          <button 
      ...
      {stores.length === 0 ? (
        <div className="flex flex-col items-center justify-center py-10 text-center flex-grow bg-slate-50 rounded-2xl border border-dashed border-slate-200 p-6">
      ...
      <div className="mt-auto pt-6 text-[11px] text-slate-400/80 bg-slate-50/50 p-4 rounded-2xl border border-slate-100/50 shrink-0 flex items-start gap-1.5" id="store-stats-help text">
